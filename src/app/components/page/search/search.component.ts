import { ProductService2 } from 'src/app/shared/services/product2.service';
...
export class SearchComponent {
  ...
  constructor(private store: Store, public productService: ProductService2, private route: ActivatedRoute, public router: Router){
